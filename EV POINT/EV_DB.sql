...
INSERT INTO admin_charging_station_list (
    Station_name, Address, City, Charger_type, Available_ports, Status
) VALUES
-- Bengaluru
('Bengaluru EV Supercharge', '100 MG Road', 'Bengaluru', 'DC Fast Charging', '6', 'active'),
('Whitefield Charge Zone', '12 Whitefield Main Road', 'Bengaluru', 'AC Level 2 Charging', '4', 'active'),

-- Mysuru
('Mysuru EV Charging Station', '55 Palace Road', 'Mysuru', 'AC Level 1 Charging', '3', 'active'),

-- Hubballi
('Hubballi Green Charge', '22 Gokul Road', 'Hubballi', 'DC Fast Charging', '5', 'active'),

-- Mangaluru
('Mangaluru EV Plug Point', '88 Beach Road', 'Mangaluru', 'AC Level 2 Charging', '2', 'active'),

-- Belagavi
('Belagavi Charge Hub', '10 Station Road', 'Belagavi', 'AC Level 1 Charging', '3', 'active'),

-- Shivamogga
('Shivamogga Rapid EV Station', '77 Garden Street', 'Shivamogga', 'DC Fast Charging', '4', 'active'),

-- Davanagere
('Davanagere EV Point', '59 MG Road', 'Davanagere', 'AC Level 2 Charging', '2', 'active');
